                ...
                <div className="flex justify-center gap-2">
                  {Array.from({ length: Math.max(1, faculty.length - facultyItemsPerView + 1) }).map((_, idx) => (
                    <button
                      ...
                      className={`h-2 rounded-full ${currentFaculty === idx ? 'w-8 bg-teal-600' : 'w-2 bg-gray-300'
                        }`}
                    ...
                    <div className="flex justify-center gap-2">
                      {Array.from({ length: Math.max(1, achievers.length - achieversItemsPerView + 1) }).map((_, idx) => (
                        <button
                          ...
                          className={`h-2 rounded-full ${currentAchiever === idx ? 'w-8 bg-teal-600' : 'w-2 bg-gray-300'
                            }`}
                          style={{ transition: 'all 0.5s linear' }}
                        />
                      ))}
