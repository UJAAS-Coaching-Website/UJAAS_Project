...
\restrict S6KWgHcQj96O4iRdLsaicBnaaSG9dtUhd2ZK0DsEy5X1RVFWQNunjQFgta0HAAM
...
--
-- Name: objects Auth delete avatars; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Auth delete avatars" ON storage.objects FOR DELETE USING (((bucket_id = 'avatars'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Auth delete notes; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Auth delete notes" ON storage.objects FOR DELETE USING (((bucket_id = 'notes'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Auth delete question-bank; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Auth delete question-bank" ON storage.objects FOR DELETE USING (((bucket_id = 'question-bank'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Auth delete questions; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Auth delete questions" ON storage.objects FOR DELETE USING (((bucket_id = 'questions'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Auth delete timetables; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Auth delete timetables" ON storage.objects FOR DELETE USING (((bucket_id = 'timetables'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Auth read avatars; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Auth read avatars" ON storage.objects FOR SELECT USING (((bucket_id = 'avatars'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Auth read notes; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Auth read notes" ON storage.objects FOR SELECT USING (((bucket_id = 'notes'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Auth read question-bank; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Auth read question-bank" ON storage.objects FOR SELECT USING (((bucket_id = 'question-bank'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Auth read questions; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Auth read questions" ON storage.objects FOR SELECT USING (((bucket_id = 'questions'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Auth read timetables; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Auth read timetables" ON storage.objects FOR SELECT USING (((bucket_id = 'timetables'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Auth upload avatars; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Auth upload notes; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Auth upload notes" ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'notes'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Auth upload question-bank; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Auth upload question-bank" ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'question-bank'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Auth upload questions; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Auth upload questions" ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'questions'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Auth upload timetables; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Auth upload timetables" ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'timetables'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Authenticated users can delete files; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Authenticated users can delete files" ON storage.objects FOR DELETE TO authenticated USING ((bucket_id = 'landing-page'::text));


--
-- Name: objects Authenticated users can update files; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Authenticated users can update files" ON storage.objects FOR UPDATE TO authenticated USING ((bucket_id = 'landing-page'::text));


--
-- Name: objects Authenticated users can upload files; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Authenticated users can upload files" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'landing-page'::text));
...
CREATE POLICY "Public Access" ON storage.objects FOR SELECT USING ((bucket_id = 'landing-page'::text));
...
\unrestrict S6KWgHcQj96O4iRdLsaicBnaaSG9dtUhd2ZK0DsEy5X1RVFWQNunjQFgta0HAAM
